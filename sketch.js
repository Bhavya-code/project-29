...
function setup() {
  ...
  polygon1 = new Polygon(100,200,70)
  ...
  //level two
  block22 = new Block(670,145,30,40);
  block23 = new Block(700,145,30,40);
  block24 = new Block(730,145,30,40);
  //top
  block25 = new Block(700,105,30,40);

  //created launcher for polygon
